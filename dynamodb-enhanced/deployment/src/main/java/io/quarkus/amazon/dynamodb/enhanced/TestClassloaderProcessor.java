package io.quarkus.amazon.dynamodb.enhanced;
 ...
 *
 * <p>
 * The Amazon SDK uses the {@link java.lang.invoke.LambdaMetafactory} under the hood to create
 ...
 *
 * <p>
 * The thing is that Quarkus uses two different {@link ClassLoader}s for tests: One that loads
 ...
 *
 * <p>
 * The crash is caused by a bug in the AWS SDK using the wrong {@link
 ...
 *
 * <p>
 * TODO The transformation applies to both tests and runtime! There should be some kind of check
