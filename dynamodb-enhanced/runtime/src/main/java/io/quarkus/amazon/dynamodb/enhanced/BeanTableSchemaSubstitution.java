 ...
 *
 * <p>
 * In static, normal java code, this would look like HashMap::new. Since this has to be done with
 ...
 *
 * <p>
 * The problem now is, that this "lambda" is effectively a new class. Since in the native image
 * the compilation is already done, it is not possible to add additional code at runtime which this
 * new class is.
 *
 * <p>
 * The solution is, not to create lambdas at runtime but rather to stick to ordinary method
